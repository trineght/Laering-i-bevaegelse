...
export const FACILITATOR_CONTENT = [
    {
        ...
        content: React.createElement(React.Fragment, null,
            // Tim Fawns
            React.createElement('h4', { className: "font-bold text-4xl mt-10 mb-6 text-[#1F7A75]" }, "💡 Tim Fawns: Sammenfiltret (entangled) pædagogik"),
            React.createElement('p', null, "Tim Fawns (2022) udvikler begrebet ", React.createElement('strong', null, "entangled pedagogy"), ", som beskriver, hvordan pædagogik, teknologi, værdier og kontekst altid er gensidigt forbundet."),
            React.createElement('p', { className: "mt-4" }, "Han kritiserer både ", React.createElement('strong', null, "teknologisk determinisme"), " (teknologien styrer læringen) og ", React.createElement('strong', null, "pædagogisk determinisme"), " (pædagogikken styrer uafhængigt af teknologi)."),
            React.createElement('p', { className: "mt-4" }, "I stedet skal læring forstås som en ", React.createElement('strong', null, "sammenfiltret praksis"), ", hvor undervisningens form og kvalitet afhænger af det komplekse samspil mellem mennesker, teknologier og formål."),
            
            React.createElement('div', { className: "bg-[#E0F2F1] p-6 rounded-lg my-8 border-l-8 border-[#1F7A75]" },
                React.createElement('p', { className: "font-medium" }, "➡️ Centralt er, at læring ikke kan planlægges ud fra faste metoder, men må tilpasses og forhandles i konteksten – en erkendelse, der ligger tæt på det postdigitale perspektiv.")
            ),
            React.createElement('p', { className: 'text-xl italic text-gray-500 mb-12' }, "📖 (Fawns, 2019, 2022)"),
            ...
            React.createElement('ul', { className: "list-disc pl-6 space-y-4 my-6 text-2xl" },
            ...
            React.createElement('p', null, "Hun ser online læring som en ", React.createElement('strong', null, "kollaborativ proces"), ", hvor viden ikke overføres, men konstrueres gennem kommunikation og refleksion. Harasim lægger vægt på, at teknologien muliggør nye sociale rum for læring – men kun, hvis den faciliteres pædagogisk."),
            React.createElement('p', { className: 'text-xl italic mt-6 text-gray-500 mb-12' }, "📖 (Harasim, Learning Theory and Online Technologies, 2017)"),
            ...
            React.createElement('p', { className: 'mt-6' }, "Lambs perspektiv peger på, at læringsrummet ikke blot indeholder teknologi, men er formet af den – og at undervisning i en postdigital tid kræver refleksiv bevidsthed om, hvordan teknologier, steder og relationer skaber læringens betingelser."),
            React.createElement('p', { className: 'text-xl italic mt-6 text-gray-500 mb-12' }, "📖 (Lamb, 2023)"),

            // Lave & Wenger
            React.createElement('div', { className: "border-t border-gray-200 my-8" }),
            React.createElement('h4', { className: "font-bold text-4xl mt-12 mb-6 text-[#1F7A75]" }, "👥 Lave & Wenger: Situeret læring"),
            React.createElement('p', null, "Jean Lave og Etienne Wenger (1991) ser læring som ", React.createElement('strong', null, "deltagelse i sociale praksisser"), " frem for tilegnelse af viden."),
            React.createElement('p', { className: "mt-4" }, "I teorien om ", React.createElement('strong', null, "situeret læring"), " lærer man gennem ", React.createElement('strong', null, "legitim perifer deltagelse"), " – altså ved gradvist at blive en del af et praksisfællesskab."),
            React.createElement('p', { className: 'mt-6' }, "Her forstås viden ikke som noget, der kan overføres fra lærer til elev, men som noget der udvikles i relation til aktivitet, kontekst og fællesskab. Teknologiske læringsmiljøer kan dermed fungere som praksisfællesskaber, hvor studerende lærer gennem samarbejde og deltagelse."),
            React.createElement('p', { className: 'text-xl italic mt-6 text-gray-500 mb-12' }, "📖 (Lave & Wenger, Situated Learning, 1991)"),

            // Wenger
            React.createElement('div', { className: "border-t border-gray-200 my-8" }),
            React.createElement('h4', { className: "font-bold text-4xl mt-12 mb-6 text-[#1F7A75]" }, "🏛️ Wenger: Praksisfællesskaber"),
            React.createElement('p', null, "I sin senere teori uddyber Etienne Wenger (1998) begrebet ", React.createElement('strong', null, "praksisfællesskaber"), " som sociale enheder, hvor deltagere deler fælles engagement, fælles praksis og gensidigt ansvar."),
            React.createElement('p', { className: 'mt-6' }, "Læring opstår i deltagelsen i ", React.createElement('strong', null, "fælles meningsskabelse"), " og i de forhandlinger, der finder sted i fællesskabet. Perspektivet er særligt relevant i digitale sammenhænge, hvor fællesskaber kan eksistere både online og fysisk, og hvor grænserne mellem læring, samarbejde og identitet bliver flydende."),
            React.createElement('p', { className: 'text-xl italic mt-6 text-gray-500 mb-12' }, "📖 (Wenger, Communities of Practice, 1998)"),
            ...
            React.createElement('p', { className: 'text-xl italic mt-6 text-gray-500 mb-12' }, "📖 (Sfard, On Two Metaphors for Learning and the Dangers of Choosing Just One, 1998)"),

            // ABC
            React.createElement('div', { className: "border-t border-gray-200 my-8" }),
            React.createElement('h4', { className: "font-bold text-4xl mt-12 mb-6 text-[#1F7A75]" }, "📋 ABC-metoden – et kollaborativt læringsdesign"),
            React.createElement('p', null, React.createElement('strong', null, "ABC-metoden"), " (Arena Blended Connected Curriculum Design) er en hurtig, kollaborativ og visuel tilgang til læringsdesign. Metoden blev oprindeligt udviklet på UCL af Young & Perović (2015)."),
            
            React.createElement('div', { className: "bg-[#FFF8E1] p-6 rounded-lg my-8 border-l-8 border-[#FFC107]" },
                 React.createElement('p', { className: "font-medium" }, "🎯 Formålet er at hjælpe undervisere med at oversætte læringsmål til konkrete aktiviteter, der kombinerer fysiske og digitale elementer i et meningsfuldt flow.")
            ),

            React.createElement('p', null, "Metoden bygger på Laurillards (2012) ", React.createElement('strong', null, "“Conversational Framework”"), ", som identificerer seks typer læringsaktiviteter:"),
            React.createElement('ul', { className: "list-disc pl-6 space-y-3 my-6 text-2xl" },
            ...
            React.createElement('p', null, "Det resulterer i et visuelt kort over læringsforløbet, som synliggør balancen mellem forskellige læringsformer."),
            React.createElement('p', { className: 'mt-6' }, "ABC-metoden fungerer som en ", React.createElement('strong', null, "pædagogisk samtale"), ", hvor undervisere forhandler teknologi og læring i kontekst."),
            
            React.createElement('div', { className: "bg-[#E0F2F1] p-6 rounded-lg my-8 border-l-8 border-[#1F7A75]" },
                React.createElement('p', { className: "font-bold text-[#1F7A75] mb-2" }, "💡 Kort sagt:"),
            ...
            React.createElement('p', { className: 'mt-6 font-semibold' }, "Kilder:"),
            React.createElement('ul', { className: 'list-disc pl-6 space-y-3 text-xl mb-12' },
            ...
            React.createElement('p', null, React.createElement('strong', null, "Læringscirkler"), " er en struktureret og dialogbaseret metode til fælles refleksion, videndeling og kompetenceudvikling i mindre grupper."),
            React.createElement('p', { className: 'mt-4' }, "Metoden er særligt udbredt gennem ", React.createElement('strong', null, "Dansk Kompetence- og Læringscenter (DKGL)"), " og bygger på erfaringer fra praksisfællesskaber og erfaringsbaseret læring."),
            
            React.createElement('h5', { className: "font-semibold text-3xl mt-8 mb-4 text-[#464646]" }, "🧩 Grundidé og proces"),
            React.createElement('p', null, "En læringscirkel består typisk af 4–8 deltagere. De gennemløber ofte følgende faser (jf. DKGL, 2021):"),
             React.createElement('ol', { className: "list-decimal pl-6 space-y-4 my-6 text-2xl" },
            ...
            React.createElement('h5', { className: "font-semibold text-3xl mt-8 mb-4 text-[#464646]" }, "💬 Læring som social proces"),
            React.createElement('p', null, "Læringscirkler hviler på en forståelse af læring som social, situeret og kontinuerlig. Det skaber et læringsrum med fokus på deltagelse og meningsskabelse frem for ren videnstilegnelse."),
            
            React.createElement('h5', { className: "font-semibold text-3xl mt-8 mb-4 text-[#464646]" }, "🌍 I en postdigital kontekst"),
            React.createElement('p', null, "Læringscirkler kan foregå hybride eller online. Her bliver teknologien en naturlig del af læringsrummet (sociomateriel praksis), hvor platforme som Teams eller Miro understøtter samskabelse."),

            React.createElement('p', { className: 'mt-8 font-semibold' }, "📚 Centrale kilder"),
             React.createElement('ul', { className: 'list-disc pl-6 space-y-3 text-xl' },
    ...
    },
    {
        ...
        content: React.createElement(React.Fragment, null,
            ...
            React.createElement('ul', { className: "list-disc pl-5 space-y-6 text-2xl" },
            ...
            React.createElement('ul', { className: "list-disc pl-5 space-y-3 text-2xl" },
    ...
    },
    {
        ...
        content: React.createElement(React.Fragment, null,
            ...
            React.createElement('h4', { className: "font-bold text-4xl mt-12 mb-6" }, "🎤 Aktiviteter:"),
            React.createElement('ul', { className: "list-disc pl-5 space-y-4 text-2xl" },
    ...
    },
    {
        ...
        content: React.createElement(React.Fragment, null,
            React.createElement('p', { className: "italic text-xl" }, "Varighed: 1–2 timer"),
            ...
            React.createElement('p', { className: "mt-6" }, "Forløbet kan gennemføres solo (individuelt refleksionsforløb) eller i grupper på 2–4 personer (kollegial workshop)."),
            ...
            React.createElement('p', { className: "mt-4" }, "Facilitator introducerer kort:"),
            React.createElement('ul', { className: "list-disc pl-5 space-y-4 mt-6 text-2xl" },
             ...
             React.createElement('p', { className: "mt-6" }, React.createElement('strong', null, 'Output:'), " Fælles forståelse af, hvordan terninger og ABC hænger sammen i læringsdesign."),
            ...
            React.createElement('p', { className: "font-semibold mt-6" }, "Sådan gør du:"),
             React.createElement('ul', { className: "list-disc pl-5 space-y-3 mt-4 text-2xl" },
            ...
            React.createElement('p', { className: "font-semibold mt-6" }, "Eksempel på kast:"),
             React.createElement('ul', { className: "list-disc pl-5 space-y-3 mt-4 text-2xl" },
            ...
            React.createElement('p', { className: "font-semibold mt-6" }, "Refleksionsspørgsmål:"),
             React.createElement('ul', { className: "list-disc pl-5 space-y-3 mt-4 text-2xl" },
             ...
             React.createElement('p', { className: "mt-6" }, React.createElement('strong', null, 'Output:'), " En idé til et konkret mini-læringsdesign."),
            ...
            React.createElement('p', { className: "font-semibold mt-6" }, "Opgave:"),
             React.createElement('ul', { className: "list-disc pl-5 space-y-4 mt-4 text-2xl" },
             ...
             React.createElement('p', { className: "mt-6" }, React.createElement('strong', null, 'Output:'), " Et færdigt mini-læringsdesign, som kan bruges eller afprøves direkte."),
            ...
            React.createElement('p', { className: "font-semibold mt-6" }, "Hvis i grupper:"),
             React.createElement('ul', { className: "list-disc pl-5 space-y-4 mt-4 text-2xl" },
             ...
             React.createElement('p', { className: "font-semibold mt-6" }, "Hvis solo:"),
             React.createElement('ul', { className: "list-disc pl-5 space-y-4 mt-4 text-2xl" },
            ...
            React.createElement('p', { className: "font-semibold mt-6" }, "Fælles opsamling:"),
             React.createElement('ul', { className: "list-disc pl-5 space-y-3 mt-4 text-2xl" },
        ...
        content: React.createElement(React.Fragment, null,
            ...
            React.createElement('div', { className: "grid grid-cols-1 sm:grid-cols-2 gap-6 mb-8" },
                ...
                React.createElement('div', { className: "border border-gray-200 rounded-lg p-6 bg-white hover:shadow-md transition-all" },
                    ...
                    React.createElement('p', { className: "text-xl text-gray-600 mb-6" }, "Print-selv terning med metoder som Casebaseret læring, PBL og Feedback."),
                ...
                React.createElement('div', { className: "border border-gray-200 rounded-lg p-6 bg-white hover:shadow-md transition-all" },
                    ...
                    React.createElement('p', { className: "text-xl text-gray-600 mb-6" }, "Print-selv terning med AI, LMS, Podcast, QR-koder m.fl."),
                ...
                React.createElement('div', { className: "border border-gray-200 rounded-lg p-6 bg-white hover:shadow-md transition-all" },
                    ...
                    React.createElement('p', { className: "text-xl text-gray-600 mb-6" }, "Print-selv terning med Whiteboard, Post-its, Rollespil og Artefakter."),
            ...
            React.createElement('div', { className: "grid grid-cols-1 sm:grid-cols-2 gap-6 mb-8" },
                React.createElement('div', { className: "border border-gray-200 rounded-lg p-6 bg-white hover:shadow-md transition-all" },
                    ...
                    React.createElement('p', { className: "text-xl text-gray-600 mb-6" }, "Skema med refleksionsspørgsmål til de 12 parametre."),
                ...
                React.createElement('div', { className: "border border-gray-200 rounded-lg p-6 bg-white hover:shadow-md transition-all" },
                    ...
                    React.createElement('p', { className: "text-xl text-gray-600 mb-6" }, "De 12 parametre til pædagogisk selvevaluering (Æblediagrammet) til print."),
            ...
            React.createElement('div', { className: "grid grid-cols-1 sm:grid-cols-2 gap-6" },
                React.createElement('div', { className: "border border-gray-200 rounded-lg p-6 bg-white hover:shadow-md transition-all" },
                    ...
                    React.createElement('p', { className: "text-xl text-gray-600 mb-6" }, "Guides og værktøjer til facilitering af læringscirkler (DKGL)."),
                 ...
                 React.createElement('div', { className: "border border-gray-200 rounded-lg p-6 bg-white hover:shadow-md transition-all" },
                    ...
                    React.createElement('p', { className: "text-xl text-gray-600 mb-6" }, "Kort og storyboard-skabelon til ABC-metoden."),
